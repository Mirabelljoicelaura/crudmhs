            ...
            <div class="card-body">
                <form action="{{route('mahasiswa.store')}}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nim" id="nim" placeholder="Your NIM">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="jurusan" id="jurusan" placeholder="Your Major">
                    </div>
